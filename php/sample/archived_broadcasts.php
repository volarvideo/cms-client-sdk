...
if(!$broadcasts = $v->broadcasts(array('site' => $site_slug, 'list' => 'archived', 'sort_by' => 'date', 'sort_dir' => 'desc', 'page' => $page)))
{
	echo $v->getError();
}
else
{
	...
	{
		?>
		<p>Sorry - there are currently no archived broadcasts available</p>
		<?php
	}
}
