...
if(!$broadcasts = $v->broadcasts(array('site' => $site_slug, 'list' => 'streaming', 'sort_by' => 'date', 'sort_dir' => 'asc', 'page' => $page)))
{
	echo $v->getError();
}
else
{
	...
	{
		?>
		<p>Sorry - there are currently no live broadcasts available</p>
		<?php
	}
}
